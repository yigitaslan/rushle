...
export class DailyStore {
  ...
  /* Bugünün oyununu hazırla (harita yüklendikten sonra çağır) */
  initToday() {
    ...
    // Kaydedilmiş günlük state varsa ve cevap eşleşiyorsa geri yükle
  ...
  // Streak continuity: sadece “bugün” veya “dün” değilse sıfırla
